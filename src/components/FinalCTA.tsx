  ...
  return (
    <section className="relative w-full bg-[#032CA5] text-center overflow-hidden">
      ...
      <div className="relative w-full max-w-[1800px] mx-auto px-5 sm:px-8 md:px-[82px] py-20 sm:py-28 lg:py-36 flex flex-col items-center">
        ...
        <p className="text-white/80 text-[16px] sm:text-[18px] md:text-[20px] font-[450] leading-[1.3] mt-5 sm:mt-8">
          Fale agora com nosso time.
        </p>
        <a
          href="#formulario"
          className="mt-8 sm:mt-10 inline-flex items-center gap-[10px] h-[46px] sm:h-[51px] px-5 sm:px-[27px] bg-[#032CA5] rounded-[12px] text-white text-[14px] sm:text-[15.5px] font-[450] leading-[15.5px] transition-colors hover:bg-[#0438c9]"
        >
